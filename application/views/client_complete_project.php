        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h1 class="page-title"> Complete Projects     
                    </h1>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    <div class="row">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided">
                                            ...
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm active" href="<?php echo site_url('/Master_controllers/all_complete_details/').$this->uri->segment(3); ?>">Completed</a>
