...
<div class="page-container">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Retailer Clients Table</span>
                            </div>
                        </div>
                            ...
                            <div class="table-toolbar">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="btn-group">
                                            <a href="<?php echo site_url('create/retailer')?>" class="btn btn-circle green"> Add Retailer Client </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" class="checkboxes" name="user_id[]" value="<?php echo $key->id ?>" />
                                                <span></span>
                                            </label>
                                        </td>    
                                        <td onclick="window.location='<?= site_url('details/retailer/'.$key->id)?>';" style='cursor:pointer'><?php echo $key->name ?></td>
                                        ...
                                        <td style="text-align: center;">
                                            <a class="badge badge-success" href="<?php echo site_url('details/retailer/'.$key->id)?>">C<?php echo $key->dynamic_id?></a>
                                            <!-- <a href="<?php echo site_url('details/retailer/'.$key->id)?>" class="btn btn-link">Edit</a> <button class="btn btn-link delete_user" value="<?php echo $key->id?>">Delete</button> -->
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <script>
        $(document).on('click' ,'.delete_user', function(e){
            ...
            .then((willDelete) => {
              if (willDelete) {
                window.location.href = "<?php echo base_url('User_controller/delete_retail_client/') ?>"+user_id;
              }
            });
        })
    </script>
