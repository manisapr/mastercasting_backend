                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided">
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm" href="<?php echo site_url('Master_controllers/all_team_members');?>">All</a>
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm active" href="<?php echo site_url('Master_controllers/all_designer');?>">Designing</a>
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm" href="<?php echo site_url('Master_controllers/all_casting');?>">Casting</a>
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm" href="<?php echo site_url('Master_controllers/all_packing');?>">Packaging</a>
                                            <a class="btn btn-transparent dark btn-outline btn-circle btn-sm" href="<?php echo site_url('Master_controllers/all_manager');?>">Manager</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                                ...
                                                /* print("<pre>");                                             
                                                print_r($get_data); */                                              
                                                foreach($get_designer as $row)                                              
                                                {                                                   
                                                $user_id=$row->id;                                                  
                                                if($row->designation_name!="Client")                    
                                                    {                                           
                                                if($designation_id=='6' && $row->designation_name!="Admin")         
                                                    {                                                       
                                                ?>
                                                    <tr class="odd gradeX">
                                                        <td>
                                                        ...
                                                        <!--<td class="ed_del"> <a href="<?php ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>  
                                                        <a href="user_delete/<?php //echo $user_id;?>"> <i class="fa fa-trash" aria-hidden="true"></i></a> 
                                                        </td>-->
                                                        <!-- Edit and delete user-->
                                                    </tr>
                                                    <?php
