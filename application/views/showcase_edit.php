            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <form action="<?php echo site_url(); ?>/Master_controllers/edit_done_showcase" method="post" enctype="multipart/form-data">
                            <div class="pro_url">
                                <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                              
                                <input type="text" placeholder="Name" name="show_name" value="<?php echo $details[0]->name; ?>">
                            </div>
                            <div class="tabgroup">
                              ...
                              <!--   <label class="tab tab--2" for="tab2">The Client</label> -->
                                <div class="panel panel--1">
                                    ...
                                    <div class="inv_ppl">
                                        <input type="hidden" name="old_pic" value="<?php echo $details[0]->image; ?>">
                                        <input type="file" name="image" id="imgInp">
                                        <img id="image_change" width="75px" src="<?php echo base_url(); ?>/uploads/showcase/<?php echo $details[0]->image; ?>" />
                                    </div>
                                    <div class="inv_ppl">
                                        <?php
                                          $resource=$details[0]->resource;
                                        ?>

                                        <select name="resource">
                                            <option>Select Showcase</option>
                                            <option value="1" <?php if($resource==1) echo "selected"; ?>>Master Showcase</option>
                                            <option value="2" <?php if($resource==2) echo "selected"; ?>>Member Showcase</option>
                                            <option value="3" <?php if($resource==3) echo "selected"; ?>>Ready-To-Print Models</option>
                                            <option value="4" <?php if($resource==4) echo "selected"; ?>>Sketch to CAD</option>
                                        </select>
