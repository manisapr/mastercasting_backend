        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <a href="#">Retail Clients</a> <i class="fa fa-circle"></i> </li>
                    <li> <span>Add Retail Client</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title">Add Retail Client
            </h1>
            <!-- END PAGE TITLE -->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">New Retail Client Form</span>
                            </div>
                            
                            
                        </div>
                        <div class="portlet-body">
                            <form id="create_user_form" action="<?= site_url('User_controller/create_retail_action')?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                <!-- == -->
                                <div class="form msg-frm">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <label for="exampleFormControlInput1">Mobile Nmber *</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" maxlength="12" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control" placeholder="" name="user[fax]">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <label for="exampleFormControlInput1">Home Number</label>
                                            <input type="text" maxlength="12" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control" placeholder="" name="user[home_contact]">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="exampleFormControlInput1">Office Number</label>
                                            <input type="text" maxlength="12" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control" placeholder="" name="user[office_contact]">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form msg-frm" style="padding: 20px !important">
                                        <div class="form-actions right todo-form-actions">
                                            <button type="submit" class="btn btn-circle btn-sm green">Create Retail Client</button>
