                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <span>Member Showcase</span> </li>
                        </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark"> <i class="icon-settings font-dark"></i> <span class="caption-subject bold uppercase">Clients</span> </div>
                                    <!-- <div class="actions"> -->
                                            ...
                                            <tbody>
												...
												?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/Master_controllers/per_client_member_show?id=').$row->id; ?>">
            ...
            <div class="modal-content">
                ...
                <!-- <div class="modal-body">
                    ...
                    <form method="post" action="<?php echo site_url('Master_controllers/insert_user');?>">
                        <div class="pro_url">
                            <input type="text" placeholder="Name" name="user_name"> </div>
                        <div class="inv_ppl">
                            <input type="email" placeholder="Email Id" name="email"> </div>
                        <div class="inv_ppl">
