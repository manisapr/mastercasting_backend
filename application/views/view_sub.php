                                ...
                                <div class="cbp-item graphic">
                                    <div class="cbp-caption">
                                        <div class="cbp-caption-defaultWrap">
                                            <a href="<?php echo site_url('Master_controllers/view_sub_deatils/'.$row->id.'/'.$this->uri->segment(3)); ?>">
                                            <img src="<?php echo base_url(); ?>/uploads/sub/<?php echo $this->uri->segment(3).'/'.$row->image; ?>" alt=""></a>
                                        </div>
