                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided">
                                            ...
                                            <a class="btn btn-transparent blue btn-outline btn-circle btn-sm active" href="<?php echo site_url('all_sales_rep');?>">Sales Rep</a>
                                            <?php if(!in_array($designation_id, [9])): ?>
