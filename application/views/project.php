...
<head>
    <meta charset="utf-8" />
    <title>Platinum and Gold Casting House | Master Casting and Cad</title>
    ...
    <link href="<?php echo base_url();?>assets/assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url();?>assets/assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />
    <link href="<?php echo base_url();?>assets/assets/layouts/layout/css/custom.min.css" rel="stylesheet" type="text/css" />
    <!-- END THEME LAYOUT STYLES -->
    <link rel="shortcut icon" href="favicon.ico" />
    <link href="<?php echo base_url();?>assets/admin/css/res_tab.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url();?>assets/admin/css/custom.css" rel="stylesheet" type="text/css" /> </head>
<!-- END HEAD -->
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark"> <i class="icon-settings font-dark"></i> <span class="caption-subject bold uppercase">All Projects</span> </div>
                                    <!-- <div class="actions"> -->
                                    ...
                                    <div class="pro_btn">
                                        ...
                                        <div class="btn_grp"> <a href="">Design</a> </div>
                                        <div class="btn_grp"> <a href="">Casting</a> </div>
                                        <div class="btn_grp"> <a href="">Polishing</a> </div>
										<div class="btn_grp"> <a href="">Packaging</a> </div>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
												...
												?>
                                                    <button id="sample_editable_1_new" class="btn sbold green" data-toggle="modal" data-target="#exampleModalLong2"> Add New <i class="fa fa-plus"></i> </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
										...
										?>
                                            <?php 	
													/* print("<pre>");
                                            		print_r($project_join_data)	;	 */							
											foreach($project_join_data_admin as $row)														
											{
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('Master_controllers/project_details/'.$project_id)?>">
														<?php echo $row->project_name;?>
                                                        </a>
                                                    </td>
                                                    <td> 
													<?php foreach($view_manager as $user_row){														
											               if($row->project_id == $user_row->project_id){
												         ?>
														 <a href="mailto:userwow@gmail.com"><?php echo $user_row->name;?></a>
											...
											?>
                                                    ...
                                                    <td class="ed_del"> <a  href="<?php echo site_url('Master_controllers/project_edit/'.$project_id ); ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        <a href="project_delete/<?php echo $project_id;?>"> <i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                                <?php 
												//$last_val=$uniq;
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
										...
										?>
											...
											foreach($project_join_data as $row)														
											{
												$project_id=$row->project_id;
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td> 
													<?php foreach($project_data as $user_row){														
											               if(($row->project_id == $user_row->project_id)  && ($user_row->designation_id!='5')){
												         ?>
														 <a href="mailto:userwow@gmail.com"><?php echo $user_row->name.',';?></a>
														 <?php   //echo $project_name; 	
											...
											?>
													 ...
													 <td>
													 <?php foreach($project_data as $user_row){														
											               if(($row->project_id == $user_row->project_id)  && ($user_row->designation_id !='2') && ($user_row->designation_id !='3') && ($user_row->designation_id !='4') && ($user_row->designation_id !='6')){
												         ?>
														 <a href="mailto:userwow@gmail.com"><?php echo $user_row->name;?></a>
														 <?php   //echo $project_name; 	
									...
									<?php if($designation_id!='6' &&  $designation_id!='1')
									{
									?>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> Project Name </th>
                                                <th> Manager assign the project </th>
                                                <!--<th> Status </th>-->
                                                <th> Start Date </th>
												<th> Price </th>
                                            </tr>
										...
										?>
											...
											foreach($user_projectr_data as $row)														
											{
												$project_id=$row->project_id;
                        ...
                        <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        <div class="media-status"> <span class="badge badge-success">8</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                        <div class="media-body">
                                            <h4 class="media-heading">Bob Nilson</h4>
                                            <div class="media-heading-sub"> Project Manager </div>
                                        </div>
                                    </li>
                                    <li class="media"> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <div class="media-status"> <span class="badge badge-danger">3</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                            <h4 class="media-heading">Deon Hubert</h4>
                                            <div class="media-heading-sub"> CTO </div>
                                        </div>
                                    </li>
                                    <li class="media"> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        <div class="media-status"> <span class="badge badge-warning">2</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <div class="media-status"> <span class="label label-sm label-success">new</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media"> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <div class="media-status"> <span class="badge badge-success">7</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                            <h4 class="media-heading">Deon Portalatin</h4>
                                            <div class="media-heading-sub"> CFO, H&D LTD </div>
                                        </div>
                                    </li>
                                    <li class="media"> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <div class="media-status"> <span class="badge badge-danger">4</span> </div> <img class="media-object" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out"> <img class="avatar" alt="" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar3.jpg" />
                                        ...
                                        <div class="post in"> <img class="avatar" alt="" src="<?php echo base_url();?>assets/assets/layouts/layout/img/avatar2.jpg" />
    ...
    <div class="modal fade signup_pop" id="exampleModalLong2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
		...
		<div class="modal-body">
						...
						<form method="post" action="<?php echo site_url('Master_controllers/insert_project');?>" onsubmit="check()">
							<div class="pro_url">
							...
							<div class="tabgroup">
								...
								/* print("<pre>");
								print_r($get_manager); */ ?>
								<select class="js-example-placeholder-single js-states form-control" name="all_manager">
                                            <?php																				
											foreach($get_manager as $row) 										
										{												
                                ...
                                <div class="inv_ppl">
									<select class="js-example-placeholder-single js-states form-control" id="select6" name="user">
			...
			<div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Name of the Project</h4>
                    <form method="post" action="<?php echo site_url('Master_controllers/update_all_project_members');?>">
					 <div class="pro_url">
					 <?php /*echo $designation_id;
							echo $id;*/
					         ?>
							<select class="js-example-placeholder-single js-states form-control" id="select2" name="project_id">
							<?php foreach($project_join_data as $row1)
							{	
                            ...
                            <div class="panel panel--1">
							 <h5>Invite People to you team</h5>
                                <?php //print_r($user_data);?>
                                    <div class="inv_ppl">
										<select class="js-example-placeholder-single js-states form-control" id="select3" name="designing">
                                            <?php																				
                                    ...
                                    <div class="inv_ppl">
									<select class="js-example-placeholder-single js-states form-control" id="select4" name="casting">
                                            <?php											
											foreach($user_data as $row) 										
											{											
                                    ...
                                    <div class="inv_ppl">
									<select class="js-example-placeholder-single js-states form-control" id="select5" name="packing">
                                            <?php											
											foreach($user_data as $row) 										
											{											
    ...
    <script src<?php echo base_url();?>
        assets / assets / layouts / layout / scripts / demo.min.js " type="
        text / javascript ">
    </script>
