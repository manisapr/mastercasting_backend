    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?php echo base_url() ?>">
                <img src="<?php echo base_url();?>assets/admin/images/logo.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo site_url('Master_controllers/login');?>" method="post">
                <div class="form-title">
                    <span class="form-title">Welcome.</span>
                    <span class="form-subtitle">Dashboard login.</span>
                </div>
                ...
                <div class="form-subtitle pull-right">
                    Best viewed in <a target="_blank" href="https://www.google.com/chrome/?brand=CHBD&gclid=EAIaIQobChMIjOSfsLvm4gIVFYmPCh3eOwPzEAAYASABEgJ1QvD_BwE&gclsrc=aw.ds"><img src="<?php echo base_url('assets/images/g_chrm_icon.png')?>" alt="google chrome" width="25"></a>
                     / <a target="_blank" href="https://www.mozilla.org/en-US/firefox/new/"><img src="<?php echo base_url('assets/images/moz_icon.png')?>" alt="mozila firefox" width="25"></a>
                </div>
            ...
            <form class="forget-form" action="<?php echo base_url() ?>" method="post">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" id="back-btn" class="btn red btn-block uppercase">Back</button>
                </div>
            </form>
