...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>assets/assets/pages/css/error.min.css" rel="stylesheet" type="text/css">
    ...
    <body class=" page-404-full-page">
        <div class="row">
            <div class="col-md-12 page-404">
                <div class="number"> <?php echo $error_type ?> </div>
                <div class="details">
                    <h3>Oops! Something Went wrong.</h3>
                    <p><?php echo $error ?></p>
                        <button onclick="window.history.back()" class="btn btn-circle green">Return Back</button>
                    </div>
                </div>
            </div>
            <!--[if lt IE 9]>
